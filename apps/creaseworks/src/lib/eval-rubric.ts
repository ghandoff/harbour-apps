...
export const ITEMS: EvalItem[] = [
  ...
  },
  {
    ...
    layer: "lens3",
    registers: ["collective"],
    prompt: "were the other ways to join in just as good as the main one?",
    help: "i.e. built in from the start as equal — not added on after the 'main' way was already designed.",
    type: "choice",
