  ...
  return (
    <main id="main" className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* google sign-in */}
        <form action="/harbour/depth-chart/api/auth/signin/google" method="POST">
          <input type="hidden" name="callbackUrl" value={`/harbour/depth-chart${callback_url}`} />
        ...
        {/* email magic link */}
        <form action="/harbour/depth-chart/api/auth/signin/resend" method="POST" className="space-y-3">
          <input type="hidden" name="callbackUrl" value={`/harbour/depth-chart${callback_url}`} />
          <input type="hidden" name="csrfToken" value="" />
          <input
            type="email"
